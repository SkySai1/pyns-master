...
class AccessDB:
    ...
    def GetFromDomains(self=None, engine:SQLAlchemy|Engine=None, qname:str|list = None, rdclass = None, rdtype:str|list = None, zone=None, decomposition:bool=False):
        try:
            ...
            if self: engine = Session(self.engine)
            else: engine = engine.session()
            with engine as con:
